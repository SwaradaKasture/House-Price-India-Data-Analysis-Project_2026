 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "This notebook contains the Exploratory Data Analysis and Machine Learning models evaluation for the House Price India dataset."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "plt.figure(figsize=(10, 6))\n",
    "sns.scatterplot(x='living area', y='Price', data=df, alpha=0.5, color='darkorange')\n",
  ...
  },
  {
   ...
   "source": [
    "plt.figure(figsize=(10, 6))\n",
    "plt.scatter(y_test, rf_preds, alpha=0.5, color='seagreen')\n",
...
with open("House_Price_India_Analysis.ipynb", "w", encoding="utf-8") as f:
